...
export function BeachProfileChart({
  ...
  // SURF-REMEDIATION LABELS (2026-08-09 PM, operator: "the fact that you
  // cannot see two breaks means you are blind") — the WC-D3 dominant-only
  // annotation filter is DELETED: every served break point gets its own
  // height/type crest label. Collision handling (computeBreakLabelStagger)
  // is unchanged and now staggers across the full served list.
